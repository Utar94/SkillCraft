...
namespace SkillCraft.Infrastructure.Migrations
{
    ...
    [Migration("20220628043702_RefactoredCharacterPowers")]
    partial class RefactoredCharacterPowers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkillCraft.Core.Characters.CharacterTalent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SkillCraft.Infrastructure.Entities.CharacterCustomization", b =>
                {
                    b.Property<int>("CharacterId")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CharacterCustomizations");
                });
            ...
            modelBuilder.Entity("SkillCraft.Core.Characters.CharacterPower", b =>
                {
                    ...
                    b.HasOne("SkillCraft.Core.Powers.Power", "Power")
            ...
            modelBuilder.Entity("SkillCraft.Core.Characters.CharacterTalent", b =>
                {
                    ...
                    b.HasOne("SkillCraft.Core.Talents.TalentOption", "Option")
                        .WithMany("CharacterTalents")
            ...
            modelBuilder.Entity("SkillCraft.Infrastructure.Entities.CharacterCustomization", b =>
                {
                    ...
                    b.HasOne("SkillCraft.Core.Customizations.Customization", "Customization")
                        .WithMany()
