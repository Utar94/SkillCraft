    ...
    public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
    {
      ...
      switch (Type)
      {
        ...
        case BonusType.Other:
          ...
          {
            results.Add(new ValidationResult("The value is not a valid bonus target.", new[] { nameof(Target) }));
          }
          break;
      ...
      if (Value == 0)
      {
        results.Add(new ValidationResult("The value must be different from 0.", new[] { nameof(Value) }));
      }
